...
export default function Sidebar({
  ...
  return (
    ...
    >
      ...
      <SimpleBar className="relative h-[calc(100%-96px)]">
        <div className="px-6 pb-5 2xl:px-8">
          ...
          <div className="absolute bottom-0 flex justify-end">
            <button
              className="pointer flex h-12 cursor-pointer items-center justify-between gap-2 text-sm font-bold text-gray-500 underline"
              onClick={() => handleWalletTransfer()}
            >
              {' '}
              <FaGoogleWallet /> Add DOFI token to your wallet
            </button>
          </div>
        </div>
      </SimpleBar>
